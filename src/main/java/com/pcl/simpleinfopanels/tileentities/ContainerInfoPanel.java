...
public class ContainerInfoPanel extends Container {
	public TileEntityInfoPanel tileEntity;	
	...
	public ContainerInfoPanel(InventoryPlayer inventory, TileEntityInfoPanel te) {
		tileEntity = te;
		...
		for (int x = 0; x < TE_INVENTORY_SLOT_COUNT; x++) {
			int slotNumber = x;
			addSlotToContainer(new CardSlot(tileEntity, slotNumber, TILE_INVENTORY_XPOS + SLOT_X_SPACING * x, TILE_INVENTORY_YPOS));
		}
	}
